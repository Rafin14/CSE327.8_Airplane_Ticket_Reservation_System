...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2023 at 12:06 AM
...
INSERT INTO `admin_info` (`admin_id`, `pass`) VALUES
('admin', 'qwerty14');
...
INSERT INTO `booking_info` (`booking_id`, `flight_id`, `passenger_id`) VALUES
(555, 'CX881', 676);
...
('CX881', 'BANGLADESH', 'HONG-KONG', '2023-10-13 07:10:00', 'CATHAY-PACIFIC', 200000),
('EK201', 'DUBAI', 'FRANKFURT', '2023-10-13 21:00:00', 'EMIRATES', 120000),
('OZ552', 'ISTANBUL', 'SEOUL', '2023-10-31 17:50:00', 'ASIANA AIRLINES', 90000),
('SEA776', 'NEW YORK', 'MIAMI', '2023-10-05 03:45:00', 'SEATTLE AIRLINES', 23000),
('TK678', 'TURKEY', 'DHAKA', '2023-12-23 12:45:00', 'TURKISH AIRLINES', 75000);
...
INSERT INTO `passenger_info` (`first_name`, `last_name`, `age`, `contact_number`, `address`, `email`, `passenger_id`) VALUES
('RAFIN', 'HASSAN', 23, '01873665309', 'DHAKA', 'RAFIN@gmail.com', 676);
...
INSERT INTO `payment_info` (`payment_id`, `ticket_price`, `vat`, `total`, `passenger_id`, `seat_id`, `booking_id`) VALUES
(123, 15000, 10, 165000, 676, '2B', 555);
